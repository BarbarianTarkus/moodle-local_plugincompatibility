...
// Only current and future versions (Moodle does not support downgrades).
// environment.xml may not yet include 5.x; add known majors so 5.0, 5.1, etc. are always selectable.
$versions = [];
